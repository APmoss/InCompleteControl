...
namespace GameStateManagement {
	...
	public abstract class GameScreen {
		...
		/// <summary>
		/// This property decides whether the screen should accept input no
		/// matter it's position on the stack.
		/// </summary>
		public bool OverrideInput {
			get { return overrideInput; }
			protected set { overrideInput = value; }
		}
