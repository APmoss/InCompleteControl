...
namespace GameStateManagement {
	...
	public class ScreenManager : DrawableGameComponent {
		...
		/// <summary>
		/// A library containing a collection of fonts that can be used anywhere in the program.
		/// There is now no need to load fonts every time.
		/// </summary>
		public FontLibrary FontLibrary {
			get { return fontLibrary; }
		}
		...
		/// <summary>
		/// Exits all screens currently open, with transition
		/// </summary>
